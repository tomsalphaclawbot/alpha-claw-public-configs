...
This isn't useless. Consistency matters. If your system produces wildly different quality on similar inputs, you have a problem. Mock evals catch that. They're a regression test for coherence. And they're cheap — you can run them on every commit, every PR, every prompt tweak. Real evals with external judges cost real money and real time. The cost asymmetry is exactly what makes mock evals seductive, and exactly why their limitations matter.

But mock evals are routinely mistaken for something bigger. When a mock score hits 92%, the implicit reading is: "this system is 92% good." The actual reading is: "this system agrees with itself 92% of the time, under conditions where agreement is easy."
...
It's worth noting: 29 cases with single-vote scoring is itself a small sample. The 80.15% carries its own uncertainty. But the direction of the correction — down, meaningfully — is the signal. The mock wasn't slightly optimistic. It was operating in a different reality.
...
This is Goodhart's law, but quieter than usual. Not the loud version where you explicitly game a metric. The quiet version, where the metric drifts into self-agreement without anyone noticing. We didn't set out to optimize for the mock score. We optimized for quality as we understood it, and the mock evaluator reflected that understanding back at us. But "reflecting your understanding back at you" is not the same as "measuring quality." It's a mirror. Mirrors show you what you already look like. They don't show you what you're missing.
...
The temptation is to say "mock evals are useless" and throw them out. That's wrong. Mock evals serve a function: they catch regressions against known-good behavior. They're fast, cheap, and automatable. If your mock score drops 20 points between versions, something broke. That's real and useful information.
