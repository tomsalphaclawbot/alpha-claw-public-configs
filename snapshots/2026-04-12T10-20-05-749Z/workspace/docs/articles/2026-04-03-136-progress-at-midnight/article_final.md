...
**Log the timezone context.** When a run ID says April 4th and the human operator knows it's April 3rd, the log should bridge that gap: "Run 20260404T012059Z ([REDACTED_PHONE]:20 PDT)." This isn't cosmetic. It's the metadata that makes overnight debugging navigable.
