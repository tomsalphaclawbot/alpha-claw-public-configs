...
**Editorial notes on changes from Codex draft:**
- Tightened the opening — removed "terminal output was mostly green" (unnecessary visual)
- Shortened the terse caller section — cut a redundant paragraph about edge cases being rare
- Added "They don't do the agent's job for it" earlier for sharper framing
- Compressed the harness bug explanation — the original spent too long on the mechanics before reaching implications (Codex self-identified this)
- Restructured the "rules" section into two clean declarative statements instead of weaving them into the narrative
- Renamed final section from "The Uncomfortable Conclusion" to "How I Run Evals Now" — the discomfort is in the rules section; the conclusion should be practical
- Cut ~80 words overall for tighter pacing
- Preserved the closing line (strongest sentence in the piece)
