...
complete -c openclaw -n "__fish_use_subcommand" -a "voicecall" -d 'Voice call utilities'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l alibaba-model-studio-api-key -d 'Alibaba Model Studio API key'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l anthropic-api-key -d 'Anthropic API key'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l arceeai-api-key -d 'Arcee AI API key'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l openrouter-api-key -d 'OpenRouter API key for Arcee AI models'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l fireworks-api-key -d 'Fireworks API key'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l lmstudio-api-key -d 'LM Studio API key'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l modelstudio-standard-api-key-cn -d 'Qwen Cloud standard API key (China)'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l modelstudio-standard-api-key -d 'Qwen Cloud standard API key (Global/Intl)'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l modelstudio-api-key-cn -d 'Qwen Cloud Coding Plan API key (China)'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l modelstudio-api-key -d 'Qwen Cloud Coding Plan API key (Global/Intl)'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l runway-api-key -d 'Runway API key'
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l stepfun-api-key -d 'StepFun API key'
...
complete -c openclaw -n "__fish_seen_subcommand_from onboard" -l vydra-api-key -d 'Vydra API key'
...
complete -c openclaw -n "__fish_seen_subcommand_from configure" -l section -d 'Configuration sections (repeatable). Options: workspace, model, web, gateway, daemon, channels, plugins, skills, health'
...
complete -c openclaw -n "__fish_seen_subcommand_from send" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from broadcast" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from poll" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from react" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from reactions" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from read" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from delete" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from pin" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from unpin" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from unpin" -l message-id -d 'Message id (or pinned message resource id for MSTeams)'
complete -c openclaw -n "__fish_seen_subcommand_from unpin" -l pinned-message-id -d 'Pinned message resource id (MSTeams: from pin or list-pins, not the chat message id)'
...
complete -c openclaw -n "__fish_seen_subcommand_from pins" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from permissions" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from search" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from create" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from reply" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from upload" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from info" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from remove" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from create" -l image -d 'Cover image URL or local file path'
...
complete -c openclaw -n "__fish_seen_subcommand_from timeout" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from kick" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from ban" -l channel -d 'Channel: feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp'
...
complete -c openclaw -n "__fish_seen_subcommand_from mcp" -a "serve" -d 'Expose OpenClaw channels over MCP stdio'
complete -c openclaw -n "__fish_seen_subcommand_from mcp" -a "list" -d 'List configured MCP servers'
complete -c openclaw -n "__fish_seen_subcommand_from mcp" -a "show" -d 'Show one configured MCP server or the full MCP config'
complete -c openclaw -n "__fish_seen_subcommand_from mcp" -a "set" -d 'Set one configured MCP server from a JSON object'
complete -c openclaw -n "__fish_seen_subcommand_from mcp" -a "unset" -d 'Remove one configured MCP server'
complete -c openclaw -n "__fish_seen_subcommand_from serve" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from serve" -l token -d 'Gateway token (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from serve" -l token-file -d 'Read gateway token from file'
complete -c openclaw -n "__fish_seen_subcommand_from serve" -l password -d 'Gateway password (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from serve" -l password-file -d 'Read gateway password from file'
complete -c openclaw -n "__fish_seen_subcommand_from serve" -l claude-channel-mode -d 'Claude channel notification mode: auto, on, or off'
complete -c openclaw -n "__fish_seen_subcommand_from serve" -s v -l verbose -d 'Verbose logging to stderr'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from show" -l json -d 'Print JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from gateway" -a "status" -d 'Show gateway service status + probe connectivity/capability'
...
complete -c openclaw -n "__fish_seen_subcommand_from gateway" -a "probe" -d 'Show gateway reachability, auth capability, and read-probe summary (local + remote)'
...
complete -c openclaw -n "__fish_seen_subcommand_from gateway" -l allow-unconfigured -d 'Allow gateway start without enforcing gateway.mode=local in config (does not repair config)'
...
complete -c openclaw -n "__fish_seen_subcommand_from run" -l allow-unconfigured -d 'Allow gateway start without enforcing gateway.mode=local in config (does not repair config)'
...
complete -c openclaw -n "__fish_seen_subcommand_from daemon" -a "status" -d 'Show service install status + probe connectivity/capability'
...
complete -c openclaw -n "__fish_seen_subcommand_from auth" -a "add" -d 'Interactive auth helper (provider auth or paste token)'
...
complete -c openclaw -n "__fish_seen_subcommand_from setup-token" -l provider -d 'Provider id'
...
complete -c openclaw -n "__fish_seen_subcommand_from order" -a "get" -d 'Show per-agent auth order override (from auth-state.json)'
complete -c openclaw -n "__fish_seen_subcommand_from order" -a "set" -d 'Set per-agent auth order override (writes auth-state.json)'
...
complete -c openclaw -n "__fish_seen_subcommand_from infer" -a "list" -d 'List canonical capability ids and supported transports'
complete -c openclaw -n "__fish_seen_subcommand_from infer" -a "inspect" -d 'Inspect one canonical capability id'
complete -c openclaw -n "__fish_seen_subcommand_from infer" -a "model" -d 'Text inference and model catalog commands'
complete -c openclaw -n "__fish_seen_subcommand_from infer" -a "image" -d 'Image generation and description'
complete -c openclaw -n "__fish_seen_subcommand_from infer" -a "audio" -d 'Audio transcription'
complete -c openclaw -n "__fish_seen_subcommand_from infer" -a "tts" -d 'Text to speech'
complete -c openclaw -n "__fish_seen_subcommand_from infer" -a "video" -d 'Video generation and description'
complete -c openclaw -n "__fish_seen_subcommand_from infer" -a "web" -d 'Web capabilities'
complete -c openclaw -n "__fish_seen_subcommand_from infer" -a "embedding" -d 'Embedding providers'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from inspect" -l name -d 'Capability id'
complete -c openclaw -n "__fish_seen_subcommand_from inspect" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from model" -a "run" -d 'Run a one-shot model turn'
complete -c openclaw -n "__fish_seen_subcommand_from model" -a "list" -d 'List known models'
complete -c openclaw -n "__fish_seen_subcommand_from model" -a "inspect" -d 'Inspect one model catalog entry'
complete -c openclaw -n "__fish_seen_subcommand_from model" -a "providers" -d 'List model providers from the catalog'
complete -c openclaw -n "__fish_seen_subcommand_from model" -a "auth" -d 'Provider auth helpers'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l prompt -d 'Prompt text'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l local -d 'Force local execution'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l gateway -d 'Force gateway execution'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from inspect" -l model -d 'Model id'
complete -c openclaw -n "__fish_seen_subcommand_from inspect" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from auth" -a "login" -d 'Run provider auth login'
complete -c openclaw -n "__fish_seen_subcommand_from auth" -a "logout" -d 'Remove saved auth profiles for one provider'
complete -c openclaw -n "__fish_seen_subcommand_from auth" -a "status" -d 'Show configured auth state'
complete -c openclaw -n "__fish_seen_subcommand_from login" -l provider -d 'Provider id'
complete -c openclaw -n "__fish_seen_subcommand_from logout" -l provider -d 'Provider id'
complete -c openclaw -n "__fish_seen_subcommand_from logout" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from image" -a "generate" -d 'Generate images'
complete -c openclaw -n "__fish_seen_subcommand_from image" -a "edit" -d 'Edit images with one or more input files'
complete -c openclaw -n "__fish_seen_subcommand_from image" -a "describe" -d 'Describe one image file'
complete -c openclaw -n "__fish_seen_subcommand_from image" -a "describe-many" -d 'Describe multiple image files'
complete -c openclaw -n "__fish_seen_subcommand_from image" -a "providers" -d 'List image generation providers'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l prompt -d 'Prompt text'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l count -d 'Number of images'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l size -d 'Size hint like 1024x1024'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l aspect-ratio -d 'Aspect ratio hint like 16:9'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l resolution -d 'Resolution hint: 1K, 2K, or 4K'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l output -d 'Output path'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l file -d 'Input file'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l prompt -d 'Prompt text'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l output -d 'Output path'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from describe" -l file -d 'Image file'
complete -c openclaw -n "__fish_seen_subcommand_from describe" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from describe" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from describe-many" -l file -d 'Image file'
complete -c openclaw -n "__fish_seen_subcommand_from describe-many" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from describe-many" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from audio" -a "transcribe" -d 'Transcribe one audio file'
complete -c openclaw -n "__fish_seen_subcommand_from audio" -a "providers" -d 'List audio transcription providers'
complete -c openclaw -n "__fish_seen_subcommand_from transcribe" -l file -d 'Audio file'
complete -c openclaw -n "__fish_seen_subcommand_from transcribe" -l language -d 'Language hint'
complete -c openclaw -n "__fish_seen_subcommand_from transcribe" -l prompt -d 'Prompt hint'
complete -c openclaw -n "__fish_seen_subcommand_from transcribe" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from transcribe" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from tts" -a "convert" -d 'Convert text to speech'
complete -c openclaw -n "__fish_seen_subcommand_from tts" -a "voices" -d 'List voices for a TTS provider'
complete -c openclaw -n "__fish_seen_subcommand_from tts" -a "providers" -d 'List speech providers'
complete -c openclaw -n "__fish_seen_subcommand_from tts" -a "status" -d 'Show TTS status'
complete -c openclaw -n "__fish_seen_subcommand_from tts" -a "enable" -d 'Enable TTS'
complete -c openclaw -n "__fish_seen_subcommand_from tts" -a "disable" -d 'Disable TTS'
complete -c openclaw -n "__fish_seen_subcommand_from tts" -a "set-provider" -d 'Set the active TTS provider'
complete -c openclaw -n "__fish_seen_subcommand_from convert" -l text -d 'Input text'
complete -c openclaw -n "__fish_seen_subcommand_from convert" -l channel -d 'Channel hint'
complete -c openclaw -n "__fish_seen_subcommand_from convert" -l voice -d 'Voice hint'
complete -c openclaw -n "__fish_seen_subcommand_from convert" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from convert" -l output -d 'Output path'
complete -c openclaw -n "__fish_seen_subcommand_from convert" -l local -d 'Force local execution'
complete -c openclaw -n "__fish_seen_subcommand_from convert" -l gateway -d 'Force gateway execution'
complete -c openclaw -n "__fish_seen_subcommand_from convert" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from voices" -l provider -d 'Speech provider id'
complete -c openclaw -n "__fish_seen_subcommand_from voices" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l local -d 'Force local execution'
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l gateway -d 'Force gateway execution'
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l gateway -d 'Force gateway execution'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from enable" -l local -d 'Force local execution'
complete -c openclaw -n "__fish_seen_subcommand_from enable" -l gateway -d 'Force gateway execution'
complete -c openclaw -n "__fish_seen_subcommand_from enable" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from disable" -l local -d 'Force local execution'
complete -c openclaw -n "__fish_seen_subcommand_from disable" -l gateway -d 'Force gateway execution'
complete -c openclaw -n "__fish_seen_subcommand_from disable" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from set-provider" -l provider -d 'Speech provider id'
complete -c openclaw -n "__fish_seen_subcommand_from set-provider" -l local -d 'Force local execution'
complete -c openclaw -n "__fish_seen_subcommand_from set-provider" -l gateway -d 'Force gateway execution'
complete -c openclaw -n "__fish_seen_subcommand_from set-provider" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from video" -a "generate" -d 'Generate video'
complete -c openclaw -n "__fish_seen_subcommand_from video" -a "describe" -d 'Describe one video file'
complete -c openclaw -n "__fish_seen_subcommand_from video" -a "providers" -d 'List video generation and description providers'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l prompt -d 'Prompt text'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l output -d 'Output path'
complete -c openclaw -n "__fish_seen_subcommand_from generate" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from describe" -l file -d 'Video file'
complete -c openclaw -n "__fish_seen_subcommand_from describe" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from describe" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from web" -a "search" -d 'Run web search'
complete -c openclaw -n "__fish_seen_subcommand_from web" -a "fetch" -d 'Fetch one URL'
complete -c openclaw -n "__fish_seen_subcommand_from web" -a "providers" -d 'List web providers'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l query -d 'Search query'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l provider -d 'Provider id'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l limit -d 'Result limit'
complete -c openclaw -n "__fish_seen_subcommand_from search" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from fetch" -l url -d 'URL'
complete -c openclaw -n "__fish_seen_subcommand_from fetch" -l provider -d 'Provider id'
complete -c openclaw -n "__fish_seen_subcommand_from fetch" -l format -d 'Format hint'
complete -c openclaw -n "__fish_seen_subcommand_from fetch" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from embedding" -a "create" -d 'Create embeddings'
complete -c openclaw -n "__fish_seen_subcommand_from embedding" -a "providers" -d 'List embedding providers'
complete -c openclaw -n "__fish_seen_subcommand_from create" -l text -d 'Input text'
complete -c openclaw -n "__fish_seen_subcommand_from create" -l provider -d 'Provider id'
complete -c openclaw -n "__fish_seen_subcommand_from create" -l model -d 'Model override'
complete -c openclaw -n "__fish_seen_subcommand_from create" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from providers" -l json -d 'Output JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from exec-policy" -a "show" -d 'Show the local config policy, host approvals, and effective merge'
complete -c openclaw -n "__fish_seen_subcommand_from exec-policy" -a "preset" -d 'Apply a synchronized preset: "yolo", "cautious", or "deny-all"'
complete -c openclaw -n "__fish_seen_subcommand_from exec-policy" -a "set" -d 'Synchronize local config and host approvals using explicit values'
complete -c openclaw -n "__fish_seen_subcommand_from show" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from preset" -l json -d 'Output as JSON'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l host -d 'Exec host target: auto|sandbox|gateway|node'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l security -d 'Exec security: deny|allowlist|full'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l ask -d 'Exec ask mode: off|on-miss|always'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l ask-fallback -d 'Host approvals fallback: deny|allowlist|full'
complete -c openclaw -n "__fish_seen_subcommand_from set" -l json -d 'Output as JSON'
...
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l latest -d 'Show the most recent pending request to approve explicitly'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l token -d 'Gateway token (if required)'
...
complete -c openclaw -n "__fish_seen_subcommand_from cron" -a "show" -d 'Show a cron job'
...
complete -c openclaw -n "__fish_seen_subcommand_from add" -l tools -d 'Tool allow-list (e.g. exec,read,write or exec read write)'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l announce -d 'Fallback-deliver final text to a chat'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l deliver -d 'Deprecated (use --announce). Fallback-delivers final text to a chat.'
complete -c openclaw -n "__fish_seen_subcommand_from add" -l no-deliver -d 'Disable runner fallback delivery'
...
complete -c openclaw -n "__fish_seen_subcommand_from disable" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from disable" -l expect-final -d 'Wait for final response (agent)'
complete -c openclaw -n "__fish_seen_subcommand_from show" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from show" -l url -d 'Gateway WebSocket URL (defaults to gateway.remote.url when configured)'
complete -c openclaw -n "__fish_seen_subcommand_from show" -l token -d 'Gateway token (if required)'
complete -c openclaw -n "__fish_seen_subcommand_from show" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from show" -l expect-final -d 'Wait for final response (agent)'
...
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l tools -d 'Tool allow-list (e.g. exec,read,write or exec read write)'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l clear-tools -d 'Remove tool allow-list (use all tools)'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l announce -d 'Fallback-deliver final text to a chat'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l deliver -d 'Deprecated (use --announce). Fallback-delivers final text to a chat.'
complete -c openclaw -n "__fish_seen_subcommand_from edit" -l no-deliver -d 'Disable runner fallback delivery'
...
complete -c openclaw -n "__fish_seen_subcommand_from proxy" -a "start" -d 'Start the local explicit debug proxy'
complete -c openclaw -n "__fish_seen_subcommand_from proxy" -a "run" -d 'Run a child command with OpenClaw debug proxy capture enabled'
complete -c openclaw -n "__fish_seen_subcommand_from proxy" -a "coverage" -d 'Report current debug proxy transport coverage and remaining gaps'
complete -c openclaw -n "__fish_seen_subcommand_from proxy" -a "sessions" -d 'List recent capture sessions'
complete -c openclaw -n "__fish_seen_subcommand_from proxy" -a "query" -d 'Run a built-in query preset against captured traffic'
complete -c openclaw -n "__fish_seen_subcommand_from proxy" -a "blob" -d 'Read a captured payload blob by id'
complete -c openclaw -n "__fish_seen_subcommand_from proxy" -a "purge" -d 'Delete all captured traffic metadata and blobs'
complete -c openclaw -n "__fish_seen_subcommand_from start" -l host -d 'Bind host'
complete -c openclaw -n "__fish_seen_subcommand_from start" -l port -d 'Bind port'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l host -d 'Bind host'
complete -c openclaw -n "__fish_seen_subcommand_from run" -l port -d 'Bind port'
complete -c openclaw -n "__fish_seen_subcommand_from sessions" -l limit -d 'Maximum sessions to show'
complete -c openclaw -n "__fish_seen_subcommand_from query" -l preset -d 'Query preset: double-sends, retry-storms, cache-busting, ws-duplicate-frames, missing-ack, error-bursts'
complete -c openclaw -n "__fish_seen_subcommand_from query" -l session -d 'Restrict to a capture session id'
complete -c openclaw -n "__fish_seen_subcommand_from blob" -l id -d 'Blob id'
...
complete -c openclaw -n "__fish_seen_subcommand_from clawbot" -a "qr" -d 'Generate a mobile pairing QR code and setup code'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l remote -d 'Use gateway.remote.url and gateway.remote token/password (ignores device-pair publicUrl)'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l url -d 'Override gateway URL used in the setup payload'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l public-url -d 'Override gateway public URL used in the setup payload'
complete -c openclaw -n "__fish_seen_subcommand_from qr" -l token -d 'Override gateway token for setup payload'
...
complete -c openclaw -n "__fish_seen_subcommand_from memory" -a "promote" -d 'Rank short-term recalls and optionally append top entries to MEMORY.md'
complete -c openclaw -n "__fish_seen_subcommand_from memory" -a "promote-explain" -d 'Explain a specific promotion candidate and its score breakdown'
complete -c openclaw -n "__fish_seen_subcommand_from memory" -a "rem-harness" -d 'Preview REM reflections, candidate truths, and deep promotions without writing'
complete -c openclaw -n "__fish_seen_subcommand_from memory" -a "rem-backfill" -d 'Write grounded historical REM summaries into DREAMS.md for UI review'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l fix -d 'Repair stale recall locks and normalize promotion metadata'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l verbose -d 'Verbose logging'
...
complete -c openclaw -n "__fish_seen_subcommand_from promote" -l agent -d 'Agent id (default: default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from promote" -l limit -d 'Max candidates'
complete -c openclaw -n "__fish_seen_subcommand_from promote" -l min-score -d 'Minimum weighted score (default: 0.75)'
complete -c openclaw -n "__fish_seen_subcommand_from promote" -l min-recall-count -d 'Minimum recall count (default: 3)'
complete -c openclaw -n "__fish_seen_subcommand_from promote" -l min-unique-queries -d 'Minimum distinct query count (default: 2)'
complete -c openclaw -n "__fish_seen_subcommand_from promote" -l apply -d 'Append selected candidates to MEMORY.md'
complete -c openclaw -n "__fish_seen_subcommand_from promote" -l include-promoted -d 'Include already promoted candidates'
complete -c openclaw -n "__fish_seen_subcommand_from promote" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from promote-explain" -l agent -d 'Agent id (default: default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from promote-explain" -l include-promoted -d 'Include already promoted candidates'
complete -c openclaw -n "__fish_seen_subcommand_from promote-explain" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from rem-harness" -l agent -d 'Agent id (default: default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from rem-harness" -l path -d 'Seed the harness from historical daily memory file(s)'
complete -c openclaw -n "__fish_seen_subcommand_from rem-harness" -l grounded -d 'Also render a grounded day-level REM preview'
complete -c openclaw -n "__fish_seen_subcommand_from rem-harness" -l include-promoted -d 'Include already promoted deep candidates'
complete -c openclaw -n "__fish_seen_subcommand_from rem-harness" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from rem-backfill" -l agent -d 'Agent id (default: default agent)'
complete -c openclaw -n "__fish_seen_subcommand_from rem-backfill" -l path -d 'Historical daily memory file(s) or directory'
complete -c openclaw -n "__fish_seen_subcommand_from rem-backfill" -l rollback -d 'Remove previously written grounded REM backfill entries'
complete -c openclaw -n "__fish_seen_subcommand_from rem-backfill" -l stage-short-term -d 'Also seed grounded durable candidates into the short-term promotion store'
complete -c openclaw -n "__fish_seen_subcommand_from rem-backfill" -l rollback-short-term -d 'Remove previously seeded grounded short-term candidates'
complete -c openclaw -n "__fish_seen_subcommand_from rem-backfill" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from voicecall" -a "call" -d 'Initiate an outbound voice call'
complete -c openclaw -n "__fish_seen_subcommand_from voicecall" -a "start" -d 'Alias for voicecall call'
complete -c openclaw -n "__fish_seen_subcommand_from voicecall" -a "continue" -d 'Speak a message and wait for a response'
complete -c openclaw -n "__fish_seen_subcommand_from voicecall" -a "speak" -d 'Speak a message without waiting for response'
complete -c openclaw -n "__fish_seen_subcommand_from voicecall" -a "end" -d 'Hang up an active call'
complete -c openclaw -n "__fish_seen_subcommand_from voicecall" -a "status" -d 'Show call status'
complete -c openclaw -n "__fish_seen_subcommand_from voicecall" -a "tail" -d 'Tail voice-call JSONL logs (prints new lines; useful during provider tests)'
complete -c openclaw -n "__fish_seen_subcommand_from voicecall" -a "latency" -d 'Summarize turn latency metrics from voice-call JSONL logs'
complete -c openclaw -n "__fish_seen_subcommand_from voicecall" -a "expose" -d 'Enable/disable Tailscale serve/funnel for the webhook'
complete -c openclaw -n "__fish_seen_subcommand_from call" -s m -l message -d 'Message to speak when call connects'
complete -c openclaw -n "__fish_seen_subcommand_from call" -s t -l to -d 'Phone number to call (E.164 format, uses config toNumber if not set)'
complete -c openclaw -n "__fish_seen_subcommand_from call" -l mode -d 'Call mode: notify (hangup after message) or conversation (stay open)'
complete -c openclaw -n "__fish_seen_subcommand_from start" -l to -d 'Phone number to call'
complete -c openclaw -n "__fish_seen_subcommand_from start" -l message -d 'Message to speak when call connects'
complete -c openclaw -n "__fish_seen_subcommand_from start" -l mode -d 'Call mode: notify (hangup after message) or conversation (stay open)'
complete -c openclaw -n "__fish_seen_subcommand_from continue" -l call-id -d 'Call ID'
complete -c openclaw -n "__fish_seen_subcommand_from continue" -l message -d 'Message to speak'
complete -c openclaw -n "__fish_seen_subcommand_from speak" -l call-id -d 'Call ID'
complete -c openclaw -n "__fish_seen_subcommand_from speak" -l message -d 'Message to speak'
complete -c openclaw -n "__fish_seen_subcommand_from end" -l call-id -d 'Call ID'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l call-id -d 'Call ID'
complete -c openclaw -n "__fish_seen_subcommand_from tail" -l file -d 'Path to calls.jsonl'
complete -c openclaw -n "__fish_seen_subcommand_from tail" -l since -d 'Print last N lines first'
complete -c openclaw -n "__fish_seen_subcommand_from tail" -l poll -d 'Poll interval in ms'
complete -c openclaw -n "__fish_seen_subcommand_from latency" -l file -d 'Path to calls.jsonl'
complete -c openclaw -n "__fish_seen_subcommand_from latency" -l last -d 'Analyze last N records'
complete -c openclaw -n "__fish_seen_subcommand_from expose" -l mode -d 'off | serve (tailnet) | funnel (public)'
complete -c openclaw -n "__fish_seen_subcommand_from expose" -l path -d 'Tailscale path to expose (recommend matching serve.path)'
complete -c openclaw -n "__fish_seen_subcommand_from expose" -l port -d 'Local webhook port'
complete -c openclaw -n "__fish_seen_subcommand_from expose" -l serve-path -d 'Local webhook path'
...
complete -c openclaw -n "__fish_seen_subcommand_from list" -l channel -d 'Channel (discord, slack, telegram)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l account -d 'Account id (for multi-account channels)'
complete -c openclaw -n "__fish_seen_subcommand_from list" -l json -d 'Print JSON'
complete -c openclaw -n "__fish_seen_subcommand_from approve" -l channel -d 'Channel (discord, slack, telegram)'
...
complete -c openclaw -n "__fish_seen_subcommand_from install" -s l -l link -d 'Link a local path instead of copying'
complete -c openclaw -n "__fish_seen_subcommand_from install" -l force -d 'Overwrite an existing installed plugin or hook pack'
complete -c openclaw -n "__fish_seen_subcommand_from install" -l pin -d 'Record npm installs as exact resolved <name>@<version>'
...
complete -c openclaw -n "__fish_seen_subcommand_from update" -l dry-run -d 'Show what would change without writing'
complete -c openclaw -n "__fish_seen_subcommand_from update" -l dangerously-force-unsafe-install -d 'Bypass built-in dangerous-code update blocking for plugins (plugin hooks may still block)'
...
complete -c openclaw -n "__fish_seen_subcommand_from status" -l timeout -d 'Timeout in ms'
complete -c openclaw -n "__fish_seen_subcommand_from status" -l json -d 'Output JSON'
complete -c openclaw -n "__fish_seen_subcommand_from capabilities" -l channel -d 'Channel (all|feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp)'
...
complete -c openclaw -n "__fish_seen_subcommand_from resolve" -l channel -d 'Channel (feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp)'
...
complete -c openclaw -n "__fish_seen_subcommand_from logs" -l channel -d 'Channel (all|feishu|googlechat|nostr|msteams|mattermost|nextcloud-talk|matrix|bluebubbles|line|zalo|zalouser|synology-chat|tlon|discord|imessage|irc|qqbot|signal|slack|telegram|twitch|whatsapp)'
