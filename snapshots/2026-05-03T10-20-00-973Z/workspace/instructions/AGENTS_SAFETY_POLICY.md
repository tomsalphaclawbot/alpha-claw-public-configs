...
- **Exec preflight safety**: avoid complex shell composition (`&&`, `||`, pipes, command substitution, inline eval) unless unavoidable; run one command at a time or use vetted script files.
