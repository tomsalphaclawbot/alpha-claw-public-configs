...
| resonance | `projects/resonance` | `tomsalphaclawbot/resonance` | Next.js + tRPC + Prisma | `http://localhost:3000` | `TBD (self-host migration in progress)` | `app`, `postgres` (selfhost profile) | `TBD` | in-progress | 2026-03-01 |
